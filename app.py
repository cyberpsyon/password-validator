    ...
    st.markdown(
        ...
        <div class="t-reveal" style="display:grid; grid-template-columns:2fr 1fr; gap:1px; background:#181830; border:1px solid #222240; margin-bottom:0.75rem;">
            <div style="background:#0D0D1A; padding:1.5rem 2rem;">
                <div style="display:flex; gap:1.5rem; align-items:flex-start;">
                    <div style="flex:1;">
                        ...
                        <div style="font-size:1.5rem; font-weight:800; color:{color}; line-height:1; font-family:'JetBrains Mono',monospace; letter-spacing:-0.02em;"><span id="pv-score" data-target="{score}">0</span><span style="font-size:0.8rem; color:#7878A0; font-weight:400;"> / {max_score}</span></div>
                    ...
                    <div style="flex:1;">
                        ...
                        <div style="font-size:1.5rem; font-weight:800; color:{color}; line-height:1; font-family:'JetBrains Mono',monospace; letter-spacing:-0.02em;">{entropy_bits:.1f}<span style="font-size:0.8rem; color:#7878A0; font-weight:400;"> bits</span></div>
            ...
            <div style="background:#0D0D1A; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:1.5rem; text-align:center;">
                ...
                <div id="pv-rating" data-rating="{html.escape(rating)}" style="color:{color}; font-size:0.9rem; font-weight:800; letter-spacing:0.12em; text-transform:uppercase; font-family:'JetBrains Mono',monospace; border:1px solid {color}; padding:0.4rem 0.9rem; box-shadow:{shadow};"></div>
            </div>
        </div>
        """),
        unsafe_allow_html=True,
